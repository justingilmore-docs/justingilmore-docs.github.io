...
> * **View Source Directory**: [GitHub Repository Folder](./)
...
> **Note:** Continuous integration automatically syncs edits made in GitBook directly to the GitHub repository source files.
